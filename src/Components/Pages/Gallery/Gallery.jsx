...
import G36 from "../../Assets/G36.jpg";
import G37 from "../../Assets/G37.jpg";
import G38 from "../../Assets/G38.jpg";
import G39 from "../../Assets/G39.jpg";
  ...
  return (
    <div id="Gallery">
      ...
      <div id="content">
        ...
        <iframe
          src="https://youtube.com/embed/NSUl1MfyVug?si=RjS82aq3fL05FguEo"
          title="YouTube video player"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowFullScreen
        ></iframe>
        ...
        <iframe
          src="https://youtube.com/embed/YUHPrk2DozQ?si=sUnw2ogWhJaD8ENo"
          title="YouTube video player"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowFullScreen
        ></iframe>
        ...
        <iframe
          src="https://youtube.com/embed/hT_SX5c-kLo?si=VR4K2rB7N2iiM-Mv"
          title="YouTube video player"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowFullScreen
        ></iframe>
      ...
      <div id="photos">
        ...
        <div className="column">
          ...
          <img src={G37} alt="couple.jpg" />
          <img src={G16} alt="couple.jpg" />
          <img src={G17} alt="couple.jpg" />
          <img src={G18} alt="couple.jpg" />
          <img src={G19} alt="couple.jpg" />
          <img src={G36} alt="couple.jpg" />
        </div>

        <div className="column">
          <img src={G24} alt="couple.jpg" />
          <img src={G25} alt="couple.jpg" />
          <img src={G26} alt="couple.jpg" />
          <img src={G27} alt="couple.jpg" />
          <img src={G28} alt="couple.jpg" />
          <img src={G29} alt="couple.jpg" />
          <img src={G30} alt="couple.jpg" />
          <img src={G31} alt="couple.jpg" />
          <img src={G32} alt="couple.jpg" />
          <img src={G33} alt="couple.jpg" />
          <img src={G34} alt="couple.jpg" />
          <img src={G35} alt="couple.jpg" />
          <img src={G38} alt="couple.jpg" />
        </div>
      </div>
    </div>
  );
